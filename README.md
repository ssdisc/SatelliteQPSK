...
- 🛰️ **真实工程数据**：使用57.7GB真实SAR卫星中频IQ数据，体验工程级信号处理挑战
- 🔧 **开放式设计**：三种技术路径可选，满足不同学习风格和技术背景需求
- 🔗 **完整链路**：从信号预处理到数据恢复的端到端QPSK接收机实现
- 📚 **教学导向**：9章详细教程、理论分析和可视化调试界面
...
└── 📂 data/                            # 🗄️ 数据文件目录（用户自行添加）
    └── 💾 sample_0611_500MHz_middle.bin # 真实SAR卫星数据文件（57.7GB）
```
...
rs = 75e6;              % 符号速率 75MHz（注意：不是37.5MHz）
r = 3;                  % 上采样倍数
...
- 🛰️ **真实数据**：57.7GB SAR卫星数据，工程级挑战
- 📚 **文档完善**：9章教程+学术论文+技术报告的完整体系
